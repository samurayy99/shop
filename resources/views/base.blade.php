...
<h2 class="brand-text mb-0" id="brand-text">{!! App\Models\Settings::get('app.name', 'Highsociety') !!}</h2>
</a></li>
</ul>
</div>
...
<h2 class="brand-text mb-0">{!! App\Models\Settings::get('app.name', 'Highsociety') !!}</h2>
</a></li>
