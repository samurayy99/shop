...
<body class="horizontal-layout horizontal-menu navbar-floating footer-static" data-open="hover"
        ...
        <div class="navbar-header d-xl-block d-none">
            <ul class="nav navbar-nav">
                <li class="nav-item"><a class="navbar-brand" href="/">
                        <h2 class="brand-text mb-0" id="brand-text">{!! App\Models\Settings::get('app.name', '🦁
                            example') !!}</h2>
                    </a></li>
            </ul>
        </div>
    ...
    <footer class="footer footer-static footer-dark footer-shadow">
        <p class="clearfix mb-0"><span class="float-md-start d-block d-md-inline-block mt-25">COPYRIGHT &copy; 2022<a
                    class="ms-25 primary-color" href="https://example.com" target="_blank">example</a><span
            ...
            <span class="float-md-end d-none d-md-block">
                ...
                <i class="fa fa-lock text-primary"></i> <a href="{{ App\Models\Settings::get('shop.pgp_key') }}"
                    target="_blank">PGP-Key</a>
                @else
