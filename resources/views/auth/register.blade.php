...
<body class="horizontal-layout horizontal-menu blank-page navbar-floating footer-static  " data-open="hover"
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
                    ...
                    <div class="auth-inner my-2">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                ...
                                <form class="auth-login-form mt-2" id="registration-form"
                                    data-action="{{ route('auth.registration.post') }}" method="POST">
                                    ...
                                    <button class="btn btn-primary w-100" tabindex="5">{{ __('Konto erstellen')
                                        }}</button>
                                </form>
            ...
            <script>
                // Define the URL for registration POST
                var registrationPostUrl = "{{ route('auth.registration.post') }}";

                // AJAX-based form submission
                $('form[action="' + registrationPostUrl + '"]').on('submit', function (e) {
                ...
                // Feather icon replacement on window load
