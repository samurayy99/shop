        ...
        <div class="col-10">
            ...
            <div class="card card-dark mb-1">
                <div class="card-body">
                    ...
                    <a class="fw-bold primary-color"
                        href="{{ route('admin.backup.download', ['fileName' => $backup['path']]) }}">{{
                        $backup['basename'] }}</a>
                    <small><b>Erstellt am:</b> {{ date('d-m-y H:s', $backup['timestamp']) }}</small>
                    <small class="float-end">
                        <a href="{{ route('admin.backup.download', ['fileName' => $backup['path']]) }}"
                            class="text-primary mx-1"><i class="fas fa-download"></i></a>
                        <a href="{{ route('admin.backup.delete', ['fileName' => $backup['path']]) }}"
