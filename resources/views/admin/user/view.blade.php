            ...
            <table id="user" class="datatables-basic table dataTable no-footer dtr-column" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.user.edit', $user->id) }}" class="primary-color"><i
                                    class="fal fa-edit"></i></a>
                            <a href="{{ route('admin.user.delete', $user->id) }}"
                                onclick="return confirm('Bist du dir sicher, dass du den Benutzer löschen willst? Jegliche Zusammenhänge werden aus der Datenbank entfernt')"
        ...
        <table id="user" class="datatables-basic table dataTable no-footer dtr-column" style="width:100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.user.delete', ['id' => $deleteRequest->user]) }}"
                            class="btn btn-danger btn-sm">Benutzer löschen</a>
                        <a href="{{ route('admin.user.decline', ['id' => $deleteRequest->id]) }}"
                            class="btn btn-success btn-sm">Anfrage ablehnen</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
