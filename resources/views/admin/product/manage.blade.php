    ...
    <div class="card">
        <div class="card-body">
            ...
            <table id="example" class="datatables-basic table dataTable no-footer dtr-column" style="width:100%">
                <thead>
                    <tr>
                        <th><button class="btn btn-sm btn-danger" id="deleteStockItems"><i
                                    class="fal fa-trash text-white"></i></button></th>
                        <th>Datensatz</th>
                        <th>Datum</th>
                        <th>Aktionen</th>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><input type="checkbox" name="stock[]" class="form-check-input"
                                value="{{ $productStockItem->id }}"></input></td>
                        <td>{{ $productStockItem->content }}</td>
                        <td>{{ date('d-m-y H:s', strtotime($productStockItem->created_at)) }}</td>
                        <td>
                            <a href="{{ route('admin.product.manage.delete', $productStockItem->id) }}"><i
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <div class="input-group input-group-merge">
                        <textarea type="number" id="content" class="form-control" name="content" placeholder="..."
                            required></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="mb-1">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="settings" id="linebyline" value="linebyline"
                            checked>
                        <label class="form-check-label" for="linebyline">Zeile für Zeile <small>(1 Zeile = 1
                                Datensatz)</small></label>
                    </div>
                    ...
                    <div class="form-check form-check-inline d-block mt-1">
                        ...
                        <label class="form-check-label" for="custom">Eigen <small>(Beispielsweise ";". Logs müssen dann
                                so aussehen: log1;log2;)</small></label>
                    </div>
                    ...
                    <button type="submit"
                        class="btn btn-primary waves-effect waves-float waves-light mt-2">Importieren</button>
