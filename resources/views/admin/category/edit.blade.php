...
<div class="content-body">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="form form-vertical" action="{{ route('admin.category.edit.save', $category->id) }}"
                method="POST">
                @csrf
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <small>Wird in der URL angezeigt. Beispiel: Kreditkarten ODER reduzierte kreditkarten.
                                Output: <code>shop.com/kategorie/kreditkarten</code> ODER
                                <code>shop.com/kategorie/reduzierte-kreditkarten</code></small>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="mb-1">
                            ...
                            <small>Kategorie wird ganz oben und mit auffälliger Farbe und einem <i
                                    class="fas fa-star text-warning"></i> angezeigt.</small>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <button type="submit"
                        class="btn btn-primary me-1 waves-effect waves-float waves-light">Speichern</button>
                    <a href="{{ route('admin.categories') }}"
                        class="btn btn-secondary me-1 waves-effect waves-float waves-light">Abbrechen</a>
                </div>
        </div>
        </form>
