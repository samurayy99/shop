            ...
            <table id="user" class="datatables-basic table dataTable no-footer dtr-column" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="primary-color" href="{{ route('admin.user.edit', $order->user_id) }}">{{
                                App\Models\User::getUsernameById($order->user_id) }}</a>
                        </td>
                        <td>
                            <a href="{{ route('admin.order.show', $order->id) }}" class="primary-color"><i
